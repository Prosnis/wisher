import{M as L,N as _e,O as ge,P as me,Q as Re,R as we,S as z,T as be,U as Te,V as ye}from"./index-D7uETdBL.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _{constructor(t,n){this.bucket=t,this.path_=n}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const t=encodeURIComponent;return"/b/"+t(this.bucket)+"/o/"+t(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(t,n){let s;try{s=_.makeFromUrl(t,n)}catch{return new _(t,"")}if(s.path==="")return s;throw xe(t)}static makeFromUrl(t,n){let s=null;const r="([A-Za-z0-9.\\-_]+)";function o(p){p.path.charAt(p.path.length-1)==="/"&&(p.path_=p.path_.slice(0,-1))}const i="(/(.*))?$",a=new RegExp("^gs://"+r+i,"i"),u={bucket:1,path:3};function c(p){p.path_=decodeURIComponent(p.path)}const g="v[A-Za-z0-9_]+",R=n.replace(/[.]/g,"\\."),m="(/([^?#]*).*)?$",w=new RegExp(`^https?://${R}/${g}/b/${r}/o${m}`,"i"),b={bucket:1,path:3},O=n===Z?"(?:storage.googleapis.com|storage.cloud.google.com)":n,f="([^?#]*)",N=new RegExp(`^https?://${O}/${r}/${f}`,"i"),T=[{regex:a,indices:u,postModify:o},{regex:w,indices:b,postModify:c},{regex:N,indices:{bucket:1,path:2},postModify:c}];for(let p=0;p<T.length;p++){const D=T[p],v=D.regex.exec(t);if(v){const pe=v[D.indices.bucket];let S=v[D.indices.path];S||(S=""),s=new _(pe,S),D.postModify(s);break}}if(s==null)throw Ce(t);return s}}class Fe{constructor(t){this.promise_=Promise.reject(t)}getPromise(){return this.promise_}cancel(t=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function je(e){return e!==void 0}function Ve(e){return typeof e=="object"&&!Array.isArray(e)}function $(e){return typeof e=="string"||e instanceof String}function W(e){return j()&&e instanceof Blob}function j(){return typeof Blob<"u"}function X(e,t,n,s){if(s<t)throw F(`Invalid value for '${e}'. Expected ${t} or greater.`);if(s>n)throw F(`Invalid value for '${e}'. Expected ${n} or less.`)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class U{constructor(t,n){this._service=t,n instanceof _?this._location=n:this._location=_.makeFromUrl(n,t.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(t,n){return new U(t,n)}get root(){const t=new _(this._location.bucket,"");return this._newRef(this._service,t)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return oe(this._location.path)}get storage(){return this._service}get parent(){const t=it(this._location.path);if(t===null)return null;const n=new _(this._location.bucket,t);return new U(this._service,n)}_throwIfRoot(t){if(this._location.path==="")throw Me(t)}}function kt(e,t,n){e._throwIfRoot("uploadBytes");const s=bt(e.storage,e._location,ie(),new k(t,!0),n);return e.storage.makeRequestWithTokens(s,he).then(r=>({metadata:r,ref:e}))}function Et(e){e._throwIfRoot("getDownloadURL");const t=mt(e.storage,e._location,ie());return e.storage.makeRequestWithTokens(t,he).then(n=>{if(n===null)throw Se();return n})}function At(e,t){const n=at(e._location.path,t),s=new _(e._location.bucket,n);return new U(e.storage,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fe="storage";function Lt(e,t,n){return e=L(e),kt(e,t,n)}function vt(e){return e=L(e),Et(e)}function St(e,t){return e=L(e),Nt(e,t)}function Bt(e=me(),t){e=L(e);const s=_e(e,fe).getImmediate({identifier:t}),r=ge("storage");return r&&Pt(s,...r),s}function Pt(e,t,n,s={}){It(e,t,n,s)}function Dt(e,{instanceIdentifier:t}){const n=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return new q(n,s,r,t,Te)}function Ct(){Re(new we(fe,Dt,"PUBLIC").setMultipleInstances(!0)),z(G,Y,""),z(G,Y,"esm2017")}Ct();export{vt as a,Bt as g,St as r,Lt as u};
