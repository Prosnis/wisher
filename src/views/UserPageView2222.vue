                  ...
                  <section class="bg-white border-round  h-full overflow-hidden mb-2 shadow-1">
                    <div class=" bg-white relative">
                      <div class="w-full md:h-16rem h-10rem  border-round">
                        <img
                          :src="profileStore.user?.wallpaperUrl"
                          alt="Обложка профиля"
            ...
            <div class="text-center  border-round-lg  bg-white h-3rem flex  justify-content-center">
              <ButtonGroup class="flex gap-3 p-1">
                <Button
                  label="вишлист"
                  icon="pi pi-book"
                  :variant="activeWishType === 'wishes' ? ' ' : 'text'"
                  @click="activeWishType = 'wishes'"
                />
                <Button
                  label="подарки"
                  icon="pi pi-sparkles"
                  :variant="activeWishType === 'reservedWishes' ? ' ' : 'text'"
                  @click="activeWishType = 'reservedWishes'"
                />
              </ButtonGroup>
            </div>
